...
//        assertTrue(presentationSigValid);
        String[] credibleOntIds = new String[]{"did:cnc:AHzUfrqpNwHBfXA72D9HciNAKuCr83SzDG"};
...
//            assertTrue(ontSdk.nativevm().ontId().verifyCredNotRevoked(vc));
    ...
    public void testVerifyStringJWTCred() throws Exception {
        String[] credibleOntIds = new String[]{"did:cnc:TD5ixYQnxmUy7qTmyfKpSmysSnjwTB1Sdi",
                "did:cnc:TYNEYu7t8tp439vmcgpJj7CR4kUqJe6ab2"};
